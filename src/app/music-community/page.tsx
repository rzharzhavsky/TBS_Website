...
const THEMED_SHABBATS = [
  ...
  {
    name: "MLK Shabbat",
    desc: "A Shabbat honoring Dr. Martin Luther King Jr.—his legacy, the pursuit of justice, and the bond between Jewish and civil rights ideals.",
    icon: (
      <svg className="w-5 h-5 text-tbs-gold-500" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            <div>
              ...
              <div className="bg-warm-50 rounded-2xl p-6 border border-warm-200">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="font-semibold text-gray-900">Rehearsals: Thursday Evenings prior to events</p>
